  ...
  >
    <div class="form-box">
      <div class="form-title">
        <div class="f-14 cur-handle" @click="$router.push('/login')">
      ...
      >
        ...
        <el-form-item prop="code">
          ...
          >
            <el-button slot="append" @click="sendCode(true)" :loading="loading"
              >发送验证码</el-button
            >
          </el-input>
        </el-form-item>
        ...
        <div align="center" class="c-999">
          {{ globalConfig.sysInfo.name }} for {{ $packageData.version }}
        </div>
      </el-form>
    </div>
  </div>
